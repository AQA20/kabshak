                    ...
                    <div class="col-md-6 mb-4 mb-md-0">
                        <div class="goal-content-box pr-md-4">
                            ...
                            <p class="goal-desc text-default mb-4">
                                هدفنا هو مساعدة أكبر عدد ممكن من الناس. من خلال تسهيل العطاءات الخيرية والاحتياجات
                                الشخصية عبر منصاتنا على الإنترنت، للوصول إلى جمهور أوسع وتحقيق تأثيرًا أوسع من أي وقت
                                مضى. سواء كنت محترفًا مشغولًا تتطلع إلى إحداث فرق أو فاعل خير لديه عمل خيري أو لديك
                                متطلبات شخصية كالأضحية وغيرها، فإننا نجعل من السهل عليك المشاركة وتقديم مساهمة ذات مغزى
                                من خلال استخدام منصاتنا عبر الإنترنت والتي تمكنك من تصفح مجموعة متنوعة من الخدمات
                                واختيار الخدمة التي تناسبك حسب احتياجاتك.
                            </p>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="alert-error alert-bg alert-button alert-block show-code-action">
                            ...
                            <p style="max-width: unset;">
                                نأمل أن تجدك هذه الرسالة في حالة جيدة. أردنا إبلاغك أن منتجاتنا قد نفذت حاليًا. ونحن
                                نعتذر عن أي إزعاج قد يسببه هذا الأمر.
                                <br>
                                نظرًا لشعبيتها الهائلة وارتفاع الطلب عليها ، فقد شهدنا زيادة غير متوقعة في المبيعات ،
                                مما أدى إلى استنفاد مخزوننا الحالي. يعمل فريقنا بجد لإعادة تخزين المنتج في أسرع وقت ممكن
                                ، ونتوقع توفره مرة أخرى في المستقبل القريب.
                                <br />
                                إذا كانت لديك أي أسئلة أو استفسارات أو كنت بحاجة إلى مزيد من المساعدة ، فيرجى عدم التردد
                                في التواصل مع فريق دعم العملاء لدينا. نحن هنا للمساعدة وتقديم أي معلومات إضافية قد
                                تحتاجها.
                                <br />
                                <br />
                        ...
                        <div class="swiper-wrapper row cols-lg-3 cols-sm-2 cols-1">
                            <div class="swiper-slide testimonial-wrap">
                                <div class="testimonial testimonial-centered testimonial-shadow">
                                    ...
                                    <blockquote>
                                        الفدية فريضة إسلامية على كلٍ من لم يستطع تعويض صيامه بعد رمضان وبها يبرئ المسلم
                                        أمام الله من إثم عدم صيام شهر رمضان. وتقدر قيمتها حسب اتفاق العلماء ب5 دولارات
                                        عن كل يوم .
                            ...
                            <div class="swiper-slide testimonial-wrap">
                                <div class="testimonial testimonial-centered testimonial-shadow">
                                    ...
                                    <blockquote>
                                        هي إحدى شعائر الإسلام، التي يتقرب بها المسلمون إلى الله بتقديم ذبح من الأنعام
                                        وذلك في أول أيام عيد الأضحى حتى آخر أيام التشريق، وهي من الشعائر المشروعة
                                        والمجمع عليها.
                            ...
                            <div class="swiper-slide testimonial-wrap">
                                <div class="testimonial testimonial-centered testimonial-shadow">
                                    ...
                                    <blockquote>
                                        هي الذبيحة التي تذبح عن المولود في اليوم السابع، وهي سنة مؤكدة في الإسلام ،وتكون
                                        شكراً لله على المولود، ذكَراً كان أو أنثى ، وهي شاتان مكافئتان عن الغلام، وشاة
                                        واحدة عن الأنثى .
                            ...
                            <div class="swiper-slide testimonial-wrap">
                                <div class="testimonial testimonial-centered testimonial-shadow">
                                    ...
                                    <blockquote>
                                        هو إيجاب المكلف على نفسه شيئا لم يكن عليه، سواء كان منجّزا أو معلقا. ويُعَرَّف
                                        أيضًا بأنه: «التزام قربة غير لازمة في أصل الشرع بلفظٍ يُشعر بذلك مثل أن يقول
                            ...
                            <div class="swiper-slide testimonial-wrap">
                                <div class="testimonial testimonial-centered testimonial-shadow">
                                    ...
                                    <blockquote>
                                        هي العطية للمحتاج على وجه التقرب إلى الخالق والمعبود ودفع البلاء , وللصدقة أثر
                                        كبير على كيان المجتمع حيث تعمل على بث روح التعاون والمؤاخاة بين أفراد المجتمع
                                        وتزيل الحسد بين الناس. والصَدقات أنواع كثيرة منها المال والعقار والثياب والطعام

...
{
    public partial class slaughterhouses : common
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                yourMaster.ChangeTitle("Slaughterhouses | Kabshak");

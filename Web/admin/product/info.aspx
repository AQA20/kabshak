<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="info.aspx.cs"
    Inherits="web.admin.product.info" %>
    ...
    <asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div>
            <input name='fake' type="text" placeholder="Name:" autocomplete="on"
                style="width: 0.1em; height: 0.1em; position: fixed; bottom: 0; opacity: 0;">
        </div>
                    ...
                    <nav class="breadcrumb-nav">
                        <div class="container">
                            <ul class="breadcrumb">
                                ...
                                <li class="">
                                    <h1 class="breadcrumb-name" style="font-size: 13px; margin-bottom: unset;">Add a new
                                        product</h1>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="container">
                            <div class="tab tab-vertical row gutter-lg">
                                <ul class="nav nav-tabs mb-6" role="tablist">
                                    ...
                                    <li class="nav-item nav-item-custom">
                                        <a href="#Product-Sub-Categories"
                                            class="nav-link Product-Sub-Categories-Link">Product - Sub Categories</a>
                                    </li>
                                    <li class="nav-item nav-item-custom d-none">
                                        <a href="#Product-Edit-Sub-Categories" class="nav-link edit-subCategory">Product
                                            - Edit Sub Categories</a>
                                    </li>
                                    <li class="nav-item nav-item-custom">
                                ...
                                <div class="tab-content mb-6">
                                    <div class="tab-pane active in" id="Product-Info" style="padding-bottom: 100px;">
                                        <div class="icon-box icon-box-side icon-box-light">
                                            <div class="icon-box-content">
                                                <h4
                                                    class="icon-box-title icon-box-title-custom text-capitalize ls-normal mb-2">
                                                    <i class="w-icon-fax mr-1"></i>Product Info</h4>
                                            </div>
                                        </div>
                                        <div class="row gutter-md">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                <input type="text" class="form-control" dir="rtl"
                                                    placeholder="اسم المنتج" id="txtProductNameAr">
                                            </div>
                                            <div class="col-md-6 mt-2">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                <select id="sub-category-list"
                                                    class="d-none form-control subcategorychange">
                                            ...
                                            <div class="col-md-6  mt-2 d-flex align-items-center">
                                                <div class="form-checkbox">
                                                    <input type="checkbox" class="custom-checkbox" id="IsNewArrival"
                                                        name="NewArrival">
                                                    <label for="IsNewArrival">Donation Product</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mt-2">
                                                <button type="button" class="btn btn-dark btn-rounded btn-sm mb-4 mt-4"
                                                    onclick="SaveProductInfo();">Save Info</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane tab-pane-custom" id="Product-Details">
                                        <div class="icon-box icon-box-side icon-box-light">
                                            <div class="icon-box-content">
                                                <h4 class="icon-box-title text-capitalize ls-normal mb-2"><i
                                                        class="w-icon-fax mr-1"></i>Product Details</h4>
                                            </div>
                                        </div>
                                        <div class="row gutter-md">
                                            <div class="col-md-6 mt-2">
                                                <textarea class="form-control" placeholder="Product Brief"
                                                    id="txtProductBriefEn" style="min-height: 150px;"></textarea>
                                            </div>
                                            <div class="col-md-6 mt-2">
                                                <textarea class="form-control" dir="rtl" placeholder="نبذة عن المنتج"
                                                    id="txtProductBriefAr" style="min-height: 150px;"></textarea>
                                            </div>
                                            ...
                                            <div class="col-md-12" style="margin-top: 100px;">
                                                <button type="button" class="btn btn-dark btn-rounded btn-sm mb-4 mt-4"
                                                    onclick="SaveProductDetails();">Save Details</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane tab-pane-custom" id="Product-Images">
                                        <div class="icon-box icon-box-side icon-box-light">
                                            <div class="icon-box-content">
                                                <h4 class="icon-box-title text-capitalize ls-normal mb-2"><i
                                                        class="w-icon-fax mr-1"></i>Product Images</h4>
                                            </div>
                                        </div>
                                        <div class="row gutter-md">
                                            <div class="col-md-12 mt-2" style="border: solid 1px #ddd; padding: 20px;">
                                                <div class="icon-box-content d-flex">
                                                    <input type="file" class="form-control-file" id="upImage"
                                                        style="padding: 7px; width: 100%; border-radius: 0.25rem;"
                                                        imagevalue="">
                                                    <a href="#" onclick="voidclick(); return false">
                                                        <figure>
                                                            <img src="#" alt="product" width="300" height="338"
                                                                class="logoImg d-none">
                                                        </figure>
                                                    </a>
                                                </div>
                                                <div id="lblUploadLogoError" class="d-none">
                                                    <div
                                                        class="alert alert-icon alert-error alert-bg alert-inline show-code-action">
                                                        <h4 class="alert-title">
                                                            <i class="w-icon-times-circle"></i>Sorry!
                                                        </h4>
                                            ...
                                            <div class="product product-single mb-4">
                                                ...
                                                <div class="swiper-slide" role="group"
                                                    style="width: 200px; margin-right: 20px; display: none;">
                                    ...
                                    <div class="tab-pane tab-pane-custom" id="Product-Price">
                                        <div class="icon-box icon-box-side icon-box-light">
                                            <div class="icon-box-content">
                                                <h4 class="icon-box-title text-capitalize ls-normal mb-2"><i
                                                        class="w-icon-fax mr-1"></i>Product Price</h4>
                                            </div>
                                        </div>
                                        <div class="row gutter-md">
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <input type="number" id="txtUsd" name="USD" class="form-control"
                                                    placeholder="USD" />
                                            </div>
                                            <div class="col-md-6 mt-2">
                                            </div>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <input type="number" id="txtDiscount" name="Disocunt"
                                                    class="form-control" placeholder="Discount" value="0" />
                                            </div>
                                            <div class="col-md-6 mt-2">
                                            </div>
                                            <div class="col-md-6 mt-2 d-none">
                                                ...
                                                <input type="number" id="txtKwd" name="KWD" class="form-control"
                                                    placeholder="KWD" />
                                            </div>
                                            <div class="col-md-6 mt-2">
                                            </div>
                                            <div class="col-md-12 mt-2">
                                                <button type="button" class="btn btn-dark btn-rounded btn-sm mb-4 mt-4"
                                                    onclick="SaveProductPrices();">Save Prices</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane tab-pane-custom" id="Product-Edit-Sub-Categories">
                                        <div class="icon-box icon-box-side icon-box-light">
                                            <div class="icon-box-content">
                                                <h4 class="icon-box-title text-capitalize ls-normal mb-2"><i
                                                        class="w-icon-fax mr-1"></i>Edit Product - Sub Category</h4>
                                            </div>
                                        </div>
                                        <div class="row gutter-md">
                                            <div class="col-md-6">
                                                <div class="row gutter-md">
                                                    <div class="col-md-12 mb-2">
                                                        ...
                                                        <select id="edit-sub-category-list"
                                                            class="form-control subcategorychange" disabled>
                                                            <option value="-1" selected>Sub Category</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-12 mb-2">
                                                        ...
                                                        <input type="number" id="txtEditSubCategoryStock" name="amount"
                                                    ...
                                                    <div class="col-md-12 mb-2">
                                                        ...
                                                        <input type="number" id="txtEditSubCategoryUsd" name="USD"
                                                    ...
                                                    <div class="col-md-12 mb-2">
                                                        ...
                                                        <input type="number" id="txtEditSubCategoryDiscount"
                                                            name="Disocunt" class="form-control" placeholder="Discount"
                                                            value="0" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row gutter-md">
                                            <div class="col-md-12">
                                                <button type="button"
                                                    class="btn btn-dark btn-rounded btn-sm mb-4 mt-4 edit-sub-category-by-token"
                                                    onclick="EditProductSubCategories();">Edit Info</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane tab-pane-custom" id="Product-Sub-Categories">
                                        <div class="icon-box icon-box-side icon-box-light">
                                            <div class="icon-box-content">
                                                <h4 class="icon-box-title text-capitalize ls-normal mb-2"><i
                                                        class="w-icon-fax mr-1"></i>Product Sub Categories</h4>
                                            </div>
                                        </div>
                                        <div class="row gutter-md">
                                            <div class="col-md-6">
                                                <div class="row gutter-md">
                                                    <div class="col-md-12 mb-2">
                                                        ...
                                                        <select id="new-sub-category-list"
                                                            class="form-control subcategorychange">
                                                            <option value="-1" selected>Sub Category</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-12 mb-2">
                                                        ...
                                                        <input type="number" id="txtSubCategoryStock" name="amount"
                                                            class="form-control" placeholder="Amount" />
                                                    </div>
                                                    <div class="col-md-12 mb-2">
                                                        <div class="icon-box-content">
                                                        ...
                                                        <input type="number" id="txtSubCategoryUsd" name="USD"
                                                            class="form-control" placeholder="USD" />
                                                    </div>
                                                    <div class="col-md-12 mb-2">
                                                        <div class="icon-box-content">
                                                        ...
                                                        <input type="number" id="txtSubCategoryDiscount" name="Disocunt"
                                                            class="form-control" placeholder="Discount" value="0" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row gutter-md">
                                            <div class="col-md-12">
                                                <button type="button" class="btn btn-dark btn-rounded btn-sm mb-4 mt-4"
                                                    onclick="SaveProductSubCategories();">Save Info</button>
                                            </div>
                                    ...
                                    <div class="tab-pane tab-pane-custom" id="Product-Stock">
                                        <div class="icon-box icon-box-side icon-box-light">
                                            <div class="icon-box-content">
                                                <h4 class="icon-box-title text-capitalize ls-normal mb-2"><i
                                                        class="w-icon-fax mr-1"></i>Product Stock</h4>
                                            </div>
                                        </div>
                                        <div class="row gutter-md">
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <input type="number" id="txtStock" name="amount" class="form-control"
                                                    placeholder="Amount" />
                                            </div>
                                            <div class="col-md-6 mt-2">
                                            </div>
                                            <div class="col-md-12 mt-2">
                                                <button type="button" class="btn btn-dark btn-rounded btn-sm mb-4 mt-4"
                                                    onclick="SaveProductStock();">Save Stock</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane tab-pane-custom" id="Product-Countries">
                                        <div class="icon-box icon-box-side icon-box-light">
                                            <div class="icon-box-content">
                                                <h4 class="icon-box-title text-capitalize ls-normal mb-2"><i
                                                        class="w-icon-fax mr-1"></i>Product Countries</h4>
                                            </div>
                                        </div>
                                        <div class="row gutter-md">
                                            <div class="col-md-12 mt-2" style="min-height: 350px;">
                                                ...
                                                <select id="choices-multiple-remove-button3"
                                                    placeholder="Select product countries" multiple>
                                                </select>
                                            </div>
                                            <div class="col-md-6 mt-2">
                                                <button type="button" class="btn btn-dark btn-rounded btn-sm mb-4 mt-4"
                                                    onclick="SaveProductCountries();">Save Info</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane tab-pane-custom" id="Product-Orders">
                                        <div class="icon-box icon-box-side icon-box-light">
                                            ...
                                            <div class="icon-box-content">
                                                <h4 class="icon-box-title text-capitalize ls-normal mb-0">Orders <span
                                                        class="nooforders"></span></h4>
                                            </div>
                                        </div>

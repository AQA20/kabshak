...
namespace web.admin
{
    public partial class products : common
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                yourMaster.ChangeTitle("Products | Kabshak");

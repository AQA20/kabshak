...
namespace vape.admin
{
    public partial class product_purposes : common
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                yourMaster.ChangeTitle("Product Purposes | Kabshak");

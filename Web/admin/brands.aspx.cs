...
namespace web.admin
{
    public partial class brands : common
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                yourMaster.ChangeTitle("Brands | Kabshak");

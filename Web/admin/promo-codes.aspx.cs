...
namespace web.admin
{
    public partial class promo_codes : common
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                yourMaster.ChangeTitle("Promo Code | Kabshak");

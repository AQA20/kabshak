...
namespace web.admin
{
    public partial class locations : common
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                yourMaster.ChangeTitle("Locations | Kabshak");

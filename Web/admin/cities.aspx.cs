...
namespace web.admin
{
    public partial class cities : common
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                yourMaster.ChangeTitle("Cities | Kabshak");

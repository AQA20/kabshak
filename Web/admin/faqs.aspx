                ...
                <nav class="breadcrumb-nav">
                    <div class="container">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-name"><h1 style="font-size: 13px; margin-bottom: unset;">FAQs</h1> </li>
                        </ul>
                    </div>
                </nav>
                    ...
                    <div class="container">
                        <div class="tab tab-vertical row gutter-lg">
                            <ul class="nav nav-tabs mb-6" role="tablist">
                                <li class="nav-item">
                                    <a id="lnkCategoriesList" href="#account-orders" class="nav-link active">FAQs List</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="tab-pane active in" id="account-orders">
                                    <div class="icon-box icon-box-side icon-box-light">
                                        ...
                                        <div class="icon-box-content">
                                            <h4 class="icon-box-title text-capitalize ls-normal mb-0">FAQs</h4>
                                        </div>
                                    </div>
                                    <div class="result">

...
namespace web.admin
{
    public partial class faqs : common
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                yourMaster.ChangeTitle("FAQs | Kabshak");

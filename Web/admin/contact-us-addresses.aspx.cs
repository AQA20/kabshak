...
namespace web.admin
{
    public partial class contact_us_addresses : common
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                yourMaster.ChangeTitle("Contact Us Addresses | Kabshak");

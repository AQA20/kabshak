...
namespace web
{
    public partial class term_and_conditions : common
    {
        public void Page_Init(Object src, EventArgs e)
        {
            site yourMaster = (site)this.Master;
            yourMaster.ChangeTitle("Terms and Conditions | Kabshak");

            string path = HttpContext.Current.Server.MapPath("~/SEO/term_and_conditions.txt");

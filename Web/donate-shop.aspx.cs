...
namespace vape
{
    public partial class donate_shop : System.Web.UI.Page
    {
        public void Page_Init(Object src, EventArgs e)
        {
            site yourMaster = (site)this.Master;
            yourMaster.ChangeTitle("Donation Shop | Kabshak");

            string path = HttpContext.Current.Server.MapPath("~/SEO/donate_shop.txt");

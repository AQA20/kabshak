        ...
        Wolmart.$body.on('click', selector, function (e) {
            ...
            setTimeout(function () {
                ...
                Wolmart.Minipopup.open({
                    ...
                    message: IsArabic ? '<p>تمت إضافته إلى عربة التسوق:</p>' : '<p>has been added to cart:</p>',
                    actionTemplate: IsArabic ? '<a href="/ar/cart.aspx" class="btn btn-rounded btn-sm">عرض عربة التسوق</a><a href="/ar/checkout.aspx" class="btn btn-dark btn-rounded btn-sm">الدفع</a>' : '<a href="/cart.aspx" class="btn btn-rounded btn-sm">View Cart</a><a href="/checkout.aspx" class="btn btn-dark btn-rounded btn-sm">Checkout</a>'
                });
            }, 500);
        });
    }
    ...
    var initCompare = function () {
        ...
        function addToCompare(e) {
            ...
            $('.compare-popup li').each(function (i) {
                if (products[i]) {
                    this.innerHTML = '<a href="#" onclick="voidclick(); return false"><figure><img src="' + products[i] + '"/></figure></a>\
    ...
    function onAddToCartSingle(e) {
        ...
        if ($alert.length) {
            ...
            var alertHtml = '<div class="alert alert-success alert-cart-product mb-2">\
                            <a href="/' + (IsArabic ? 'ar/' : '') + 'cart.aspx" class="btn btn-success btn-rounded">View Cart</a>\

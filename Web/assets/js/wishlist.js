...
function FillWishListData(data) {
    if (data.length > 0) {
        ...
        $('.wishlist-table').html('<div style="font-weight: 500;color: #593930;padding: 5px;font-size: 20px;"><span class="w-icon-search-plus" style="padding-right: 5px;padding-left: 5px;"></span>No result found!</div>');

                ...
                items.push(`<div class="store-wrap mb-4">
                                    <div class="store store-grid">
                                        <div class="store-header">
                                            <figure class="store-banner" style="background: #05D7A0; min-height: 160px;">
                                            </figure>
                                        </div>
                                        <!-- End of Store Header -->
                                        ...
                                        <div class="store-footer">
                                            <figure class="seller-brand" style="background-color: #05D7A0;">
                                                <img src="${mainImg == '#' ? '/assets/images/alter_logo.png' : mainImg}" alt="not fill image" width="80" height="80">
                                            </figure>

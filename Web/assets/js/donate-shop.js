...
function GetProductsList() {
    ...
    if (!(allParams.sort == "-1" && (location.href == "/donate-shop" || location.href == "/ar/donate-shop"))) {
        apiURL = apiURL + "&sort=" + (allParams.sort ? allParams.sort : "-1").toString();
        apiURL = apiURL.replace("?&", "?");
        history.pushState({}, null, apiURL);
    }

    if (!(allParams.start == "1" && (location.href == "/donate-shop" || location.href == "/ar/donate-shop"))) {
        apiURL = apiURL + "&start=" + (allParams.start ? allParams.start : "-1").toString();
        apiURL = apiURL.replace("?&", "?");
        history.pushState({}, null, apiURL);
    }

    if (!(allParams.end == "50" && (location.href == "/donate-shop" || location.href == "/ar/donate-shop"))) {
            ...
            items.push(`<div class="product product-list" style="border-bottom: solid 1px #eee;margin-bottom: 20px;">
                                    ...
                                    <div class="product-details" style="width:100%;min-height: 265px;">
                                        ...
                                        <div class="product-action" style="position: absolute;">
                                            <a href="${productURL}" class="btn-product" title="${IsArabic ? "تبرع الأن" : "Donate Now"}" style="min-width: 250px;">${IsArabic ? "تبرع الأن" : "Donate Now"} </a>
                                        </div>
                                    </div>
                                </div>`);
        }
...
function CleanAll() {
    if (IsArabic)
        window.location.href = "/ar/donate-shop.aspx";
    else
        window.location.href = "/donate-shop.aspx";
}

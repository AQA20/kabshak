            ...
            items.push(`<tr class="RemoveRecord_14">
                            ...
                            <td class="wishlist-action">
                                <div class="d-lg-flex justify-content-between">
                                    <button type="button" class="btn btn-quickview btn-outline btn-default btn-rounded btn-sm mb-2 mb-lg-0" onClick="EditFaq(${index});">Edit</button>
...
function ChangeQuestionStatus(btn, classname, id, active) {
    ...
    fdata.append('auth_token', "");  $.ajax({
        cache: false,
        data: fdata,
        url: '/api/main.asmx/chnage_faqs_activation_status',
        type: 'post',
        processData: false,
        contentType: false,
        success: function (data) {
...
function SaveQuestionInfo() {
    ...
    if (val) {
        ...
        fdata.append('auth_token', "");  $.ajax({
            cache: false,
            data: fdata,
            url: '/api/main.asmx/add_faqs_question_info',
            type: 'post',
            processData: false,
            contentType: false,
            success: function (data) {
...
function EditQuestionInfoById(id) {
    ...
    if (val) {
        ...
        fdata.append('auth_token', "");  $.ajax({
            cache: false,
            data: fdata,
            url: '/api/main.asmx/edit_question_info',
            type: 'post',
            processData: false,
            contentType: false,
            success: function (data) {

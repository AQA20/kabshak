                           ...
                           <td class="product-stock-status">
                            ...
                            <td class="product-stock-status">
                                <span class="wishlist-in-stock">
                                    ...
                                    <br/><span class="${item.PromoCode.trim() == '' ? 'd-none' : '' }" style="font-size: 10px;background: #593930;color: #ffffff;padding: 5px;border-radius: 3px;">Promo code: ${item.PromoCode.trim()}</span>
                                </span>
                            </td>

<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="order-complete.aspx.cs" Inherits="web.order_complete" %>
        ...
        <nav class="breadcrumb-nav">
            <div class="container">
                <ul class="breadcrumb shop-breadcrumb bb-no" style="margin-top: unset;">
                    <li><a href="#" onclick="voidclick(); return false">Shopping Cart</a></li>
                    <li><a href="#" onclick="voidclick(); return false">Checkout</a></li>
                    <li class="active"><a href="#" onclick="voidclick(); return false">Order Complete</a></li>
                </ul>
            </div>
        </nav>
        ...
        <div class="page-content mb-10 pb-2">
            <div class="container">
                <div class="order-success text-center font-weight-bolder text-dark">
                    ...
                    <br />
                    <em style="font-size: 12px;">Your evaluation of the request process:</em>
                    <div class="container">
                        <div class="feedback">
                            <div class="rating">
                ...
                <a href="/shop" class="btn btn-dark btn-rounded btn-icon-left btn-back mt-6"><i class="w-icon-long-arrow-left"></i>Back To List</a>
            </div>
        </div>
        <!-- End of PageContent -->
    </main>

...
namespace vape.AR
{
    public partial class ship_shop : System.Web.UI.Page
    {
        public void Page_Init(Object src, EventArgs e)
        {
            site yourMaster = (site)this.Master;
            yourMaster.ChangeTitle("متجر الشحن و التوصيل | كبشك");

            string path = HttpContext.Current.Server.MapPath("~/SEO/ship_shop_ar.txt");

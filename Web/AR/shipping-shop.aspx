<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="shipping-shop.aspx.cs" Inherits="vape.AR.ship_shop" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="hide-res" id="search-filters-items">
        ...
        <input type="text" hidden name="newarrival" value="2" />
        ...
        <nav class="breadcrumb-nav">
            <div class="container">
                <ul class="breadcrumb mb-4">
                    ...
                    <li><h1 style="font-size: 13px; margin-bottom: unset;">متجر التوصيل</h1> </li>
                </ul>
            </div>
        </nav>
        <!-- End of Breadcrumb -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script src="/assets/js/shipping-shop.js"></script>
</asp:Content>

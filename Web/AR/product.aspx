                        ...
                        <div class="product product-single row">
                            ...
                            <div class="col-md-6 mb-4 mb-md-6 product-data-custom">
                                <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                    ...
                                    <div class="product-categories">
                                        يبداء من:<div class="product-price"><ins class="new-price"></ins></div>
                                    </div>
                            ...
                            <div class="tab tab-nav-boxed tab-nav-underline product-tabs">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item d-none">
                                        <a href="#product-tab-vendor" class="nav-link">معلومات العلامة التجارية</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#product-tab-reviews" class="nav-link d-none">ملاحظات العملاء</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                                    ...
                                                    <div class="accordion accordion-icon accordion-simple show-code-action">
                                                        <div class="card">
                                                            <div class="card-header">
                                                                <a href="#collapse3-2" class="expand" style="padding-right: unset !important;"><i class="w-icon-exclamation-circle"></i>معلومات العلامة التجارية</a>
                                                            </div>
                                                            <div class="card-body collapsed" id="collapse3-2" style="display: none;">
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-9 pl-2 pl-md-6 mb-4">
                                                                        ...
                                                                        <div class="vendor-info" style="padding-right: 20px;"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="tab-pane" id="product-tab-vendor">
                                        <div class="tab-pane active in" id="product-tab-vendor2" style="padding-top: unset;">
                                            <div class="row mb-3">
                                                <div class="col-md-6 mb-4 vendor-banner-image-dev">
                                                    <figure class="vendor-banner vendor-banner-image br-sm">
                                                    </figure>
                                                </div>
                                        ...
                                        <div class="row mb-4">
                                                ...
                                                <div class="ratings-wrapper">
                                                    <div class="avg-rating-container">
                                                        ...
                                                        <div class="avg-rating">
                                                            <p class="text-dark mb-1">متوسط ​​تقييم</p>
                                            ...
                                            <div class="col-xl-8 col-lg-7 mb-4">
                                                <div class="review-form-wrapper">
                                                    <h3 class="title tab-pane-title font-weight-bold mb-1">أرسل رأيك</h3>
                                                    <p class="mb-3">
                                                        لن يتم نشر عنوان بريدك الإلكتروني. لا حقول مطلوبة.
                                                    </p>

                                                    <div class="rating-form">
                                                        <label for="rating">تقييمك لهذا المنتج:</label>
                                                    ...
                                                    <textarea cols="30" rows="6" placeholder="اكتب رأيك هنا ..." class="form-control" id="review"></textarea>
                                                    <div class="row gutter-md mt-2">
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="اسمك" id="author">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="بريدك الالكتروني" id="email_1">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="alert-rating alert alert-icon alert-warning alert-bg alert-inline show-code-action mt-2 d-none">
                                                        <h4 class="alert-title">
                                                            <i class="w-icon-exclamation-triangle"></i>تحذير!</h4>
                                                        يجب عليك تحديد نجوم التصنيف للمنتج!
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <div class="cart-action">
                                            <a href="/ar/cart.aspx" class="btn btn-dark btn-outline btn-rounded mb-1"><i class="w-icon-cart pl-1 pr-1"></i>مشاهدة عربة التسوق</a>
                                            <a href="/ar/checkout.aspx" class="btn btn-primary  btn-rounded mb-1">أنتقل الى الدفع<i class="w-icon-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="widget widget-icon-box mb-6">
                                        ...
                                        <div class="icon-box icon-box-side">
                                            ...
                                            <div class="icon-box-content">
                                                ...
                                                <p class="text-default">وذلك حسب الشروط والاحكام</p>
                                            </div>
                                        </div>
                                        <div class="icon-box icon-box-side">
                                            <span class="icon-box-icon text-dark">
                                            ...
                                            <div class="icon-box-content">
                                                ...
                                                <p class="text-default">
                                                    ...
                                                    الساعة الثامنة صباحا وحتى الساعة
                                                    التاسعة مساء 
                                                </p>
                                            </div>
                                        </div>
                          ...
                          <%--          <div class="widget widget-banner mb-9 sale-tag">
                                        <div class="banner banner-fixed br-sm">
                                            ...
                                            <div class="banner-content">
                                                <div class="banner-price-info font-weight-bolder text-white lh-1 ls-25">
                                                    <span></span><sup class="font-weight-bold">%</sup><sub class="font-weight-bold text-uppercase ls-25">خصم</sub>
                                                </div>
                                            </div>
                                        </div>
                                    </div>--%>
                                    ...
                                    <div class="widget widget-products d-none">
                                        <div class="title-link-wrapper mb-2">
                                            <h4 class="title title-link font-weight-bold">منتجات بسعر مخفض</h4>
                                        </div>
                    ...
                    <div class="Shipping-Address-AddToCart d-none">
                        <div class="row">
                            ...
                            <div class="col-xs-6  mb-2">
                                <div class="form-group">
                                    <label>رقم التواصل * <em>الأردن فقط</em></label>
                             ...
                             <div class="col-md-12">
                                <div class="form-group">
                                     <p class="mb-2">ملاحظات تقطيع اللحم (اختياري)</p>
                                    <textarea class="form-control mb-0" id="product-cutting-notes" name="product-cutting-notes" cols="30" rows="4" placeholder="نقدم خدمة تحديد طريقة تقطيع اللحم التي ترغب بها."></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
